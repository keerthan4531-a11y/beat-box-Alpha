...
If you discover a security vulnerability in Beat Box, please report it responsibly:

1. **Do NOT** create a public GitHub issue
2. Email us at: [security@Beat Box.fun](mailto:security@Beat Box.fun)
...
Beat Box is committed to user privacy:
...
- Email: [security@Beat Box.fun](mailto:security@Beat Box.fun)
- GitHub: Create a private security advisory

Thank you for helping keep Beat Box secure!
