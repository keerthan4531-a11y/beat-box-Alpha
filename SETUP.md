...
This document provides instructions for setting up the Beat Box project for development.
...
Beat Box supports AI-powered lyrics translation. You can configure this in **Settings -> AI Settings**.
