        ...
        Box(
            modifier = Modifier
                ...
                .liquidGlass(
                    ...
                    glassAlpha = if (isDynamicBackground) 0.88f else 0.78f,
                    elevation = 10.dp
                )
        ) {
        ...
        mediaMetadata?.let { metadata ->
            ...
            Row(
                ...
                if (metadata.artists.any { it.name.isNotBlank() }) {
                    ...
                    iad1tya.echo.music.ui.component.badges.VerifiedArtistBadge()
                    iad1tya.echo.music.ui.component.badges.LosslessBadge()
                }
            }
...
private fun LegacyMiniPlayer(
    ...
    Box(
        modifier = modifier
            ...
            .background(
                if (pureBlack && iad1tya.echo.music.ui.theme.isAppInDarkTheme()) Color.Black
