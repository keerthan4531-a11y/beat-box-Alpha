    ...
    Column(
        ...
        if (showSaavnAudioWarning) {
            DefaultDialog(
                ...
                Text("Saavn (320kbps) streams run through Beat Box's servers and cost real money to keep running. If you find it useful, please consider donating to help keep this alive.\n\nNote: If Saavn playback fails, the app automatically falls back to YouTube Music's Opus stream.")
            }
        }
        ...
        if (showLosslessAudioWarning) {
            DefaultDialog(
                ...
                Text("Lossless (Qobuz) streams run through Beat Box's servers and cost real money to keep running. If you find it useful, please consider donating — it directly helps cover server costs.\n\n" + stringResource(R.string.lossless_audio_warning))
            }
        }
