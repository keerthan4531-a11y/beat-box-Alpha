...
import iad1tya.echo.music.ui.theme.glassmorphismSource
import iad1tya.echo.music.ui.theme.glassmorphismEffect
            ...
            BoxWithConstraints(
                modifier = Modifier
                    ...
                    .background(
                        ...
                        else if (useDarkTheme) MaterialTheme.colorScheme.surface 
                    ...
                    .drawBehind {
                        if (!pureBlack && useDarkTheme) {
                            ...
                            // Ultra-luxury luminous ivory ambient glow in Light Mode
                            drawRect(
                                brush = androidx.compose.ui.graphics.Brush.radialGradient(
                                    colors = listOf(themeColor.copy(alpha = 0.08f), Color.Transparent),
                ...
                var isToolbarVisible by androidx.compose.runtime.saveable.rememberSaveable { mutableStateOf(true) }
                ...
                val animatedNavPadding by androidx.compose.animation.core.animateDpAsState(
                    targetValue = if (isToolbarVisible) navPadding else 0.dp,
                    animationSpec = androidx.compose.animation.core.spring(dampingRatio = 0.8f, stiffness = 400f),
                    label = "animatedNavPadding"
                )

                val navSlideDistance = bottomInset + FloatingToolbarBottomPadding + NavigationBarHeight
                val autoHideOffset by androidx.compose.animation.core.animateDpAsState(
                    targetValue = if (isToolbarVisible) 0.dp else navSlideDistance,
                    animationSpec = androidx.compose.animation.core.spring(dampingRatio = 0.8f, stiffness = 400f)
                )
                ...
                val playerBottomSheetState = rememberBottomSheetState(
                    ...
                    collapsedBound = bottomInset +
                        (if (!showRail && shouldShowNavigationBar) animatedNavPadding else 0.dp) +
                ...
                CompositionLocalProvider(
                    ...
                    val dominantColor = remember(useDarkTheme) { if (useDarkTheme) Color(0xFF1E1E2E) else Color(0xFFF5F7FA) } // Default background
                    iad1tya.echo.music.ui.theme.ProvideHazeState {
                        iad1tya.echo.music.ui.component.DynamicBackground(
                            dominantColor = dominantColor,
                            modifier = Modifier.glassmorphismSource()
                        ) {
                            Scaffold(
                            ...
                            AnimatedVisibility(
                                ...
                                Row {
                                    TopAppBar(
                                        ...
                                        .glassmorphismEffect(cornerRadius = 0.dp)
                                    )
                                }
                            }
                        },
                        bottomBar = {
                            ...
                            if (!showRail && currentRoute != "update" && currentRoute != "listen_together/chat" && currentRoute != "ambient_mode" && currentRoute != "uptime" && currentRoute?.startsWith("settings") != true && currentRoute != Screens.AiAssistant.route) {
                                Box {
                                    BottomSheetPlayer(
                                    ...
                                    val navOffsetY = if (navigationBarHeight == 0.dp) {
                                        ...
                                        slideOffset + hideOffset + autoHideOffset
                                    }
                                ...
                                if (currentRoute != "update" && currentRoute != "listen_together/chat" && currentRoute != "ambient_mode" && currentRoute != "uptime" && currentRoute?.startsWith("settings") != true && currentRoute != Screens.AiAssistant.route) {
                                    BottomSheetPlayer(
                                        state = playerBottomSheetState,
                                        navController = navController,
                                        pureBlack = pureBlack
