...
constructor(
    ...
    private val dataSourceFactory =
        ResolvingDataSource.Factory(
            ...
            val cleanMime = rawMime.split(";")[0].trim()
            val extractedCodecs = rawMime.split("codecs=").getOrNull(1)?.removeSurrounding("\"")?.substringBefore(";")?.trim()
                ?: when {
                    cleanMime.contains("flac", ignoreCase = true) -> "flac"
                    cleanMime.contains("mp4", ignoreCase = true) || cleanMime.contains("m4a", ignoreCase = true) -> "mp4a.40.2"
                    cleanMime.contains("webm", ignoreCase = true) -> "opus"
                    else -> "opus"
                }
