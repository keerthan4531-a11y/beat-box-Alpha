                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/keerthan4531-a11y/beat-box-Alpha/releases/download/${currentStatus.version}/beatbox.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/keerthan4531-a11y/beat-box-Alpha/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/keerthan4531-a11y/beat-box-Alpha/releases/download/$tagWithPrefix/changelog.json")
